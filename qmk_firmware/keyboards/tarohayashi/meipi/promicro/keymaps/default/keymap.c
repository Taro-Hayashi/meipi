...
void joystick_task(){
    if(analogReadPin(F5) - 350 > 175){
        register_code16(KC_WH_R);
        pressedkey = "J1 RIGHT";
    }else if(analogReadPin(F5) - 350 < 175){
    ...
    if(analogReadPin(F5) - 350 < -175){
     ...
     if(analogReadPin(F4) - 350 > 175){
        register_code16(KC_WH_U);
        pressedkey = "J1 UP";
    }else if(analogReadPin(F4) - 350 < 175){
    ...
    if(analogReadPin(F4) - 350 < -175){
     ...
     if(analogReadPin(F7) - 350 > 175){
        register_code16(KC_RGHT);
        pressedkey = "J0 RIGHT";
    }else if(analogReadPin(F7) - 350 < 175){
    ...
    if(analogReadPin(F7) - 350 < -175){
     ...
     if(analogReadPin(F6) - 350 > 175){
        register_code16(KC_UP);
        pressedkey = "J0 UP";
    }else if(analogReadPin(F6) - 350 < 175){
